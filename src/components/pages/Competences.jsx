            ...
            <div className="flex flex-col gap-12 w-full max-w-6xl">
                ...
                <div>
                    ...
                    <div className="flex flex-wrap gap-6 justify-center">
                        <Hover3DCard>
                            <div className="card bg-primary text-primary-content w-80 shadow-xl h-full">
                ...
                <div>
                    ...
                    <div className="flex flex-wrap gap-6 justify-center">
                        <Hover3DCard>
                            <div className="card bg-secondary text-secondary-content w-80 shadow-xl h-full">
                                <div className="card-body items-center text-center">
                ...
                <div>
                    ...
                    <div className="flex flex-wrap gap-6 justify-center">
                        <Hover3DCard>
                            <div className="card bg-accent text-accent-content w-80 shadow-xl h-full">
                                <div className="card-body items-center text-center">
